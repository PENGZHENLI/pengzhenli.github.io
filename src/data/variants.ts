...
const environment: Variant = {
  ...
  bio:
    "I am a Ph.D. candidate in Economics at the University of Tennessee, Knoxville, on the 2026–27 job market. I am an applied economist working on environmental, energy, and resource questions. My published work asks whether green-technology innovation actually lowers CO₂ emissions (Technological Forecasting and Social Change, 2019; 1,000+ citations), how sustainable-aviation-fuel supply chains should be sited and financed (Biomass and Bioenergy, 2026; Transportation Research Record, 2024), and how market power shapes agricultural prices (JAAEA, 2023). My job market paper builds trade-restrictiveness indices for discriminatory tariffs — a tool I am now applying to carbon border adjustments and green-goods tariffs.",
  cvFile: "/files/Pengzhen_Li_CV_Environment.pdf",
  cvLabel: "CV",
  paperOrder: ["jmp", "safwelfare", "safrisk", "safstoch", "safnash", "pork", "endorse", "shapley"],
