...
const trade: Variant = {
  ...
  cvLabel: "CV",
  paperOrder: ["jmp", "shapley", "endorse", "safwelfare", "safrisk", "pork"],
...
const environment: Variant = {
  ...
  cvLabel: "CV",
  paperOrder: ["jmp", "safwelfare", "safrisk", "pork", "endorse", "shapley"],
