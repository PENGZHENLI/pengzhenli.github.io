...
const trade: Variant = {
  ...
  cvLabel: "CV",
  paperOrder: ["jmp", "shapley", "endorse", "safwelfare", "safstoch", "safnash"],
...
const environment: Variant = {
  ...
  cvLabel: "CV",
  paperOrder: ["jmp", "safwelfare", "safstoch", "safnash", "endorse", "shapley"],
